    ...
    <div className="card">
      <div className="card-header">
        ...
        <div className="card-title-group">
          ...
          <div className="card-date">{props.title.date}</div>
        </div>
      </div>
      <img className="card-image" src={props.title.image} alt="Logo" />
      <div className="card-text">{props.title.description}</div>
